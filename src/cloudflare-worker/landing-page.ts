        ...
        <div class="installation-method">
            ...
            <div class="method-content" id="claude-cli-content">
                ...
                <div class="code-container">
                    ...
                    <pre id="claude-cli">claude mcp add --transport http SDK ${o}/mcp --header "x-cloudinary-auth: ..." --header "x-oauth2: ..." </pre>
                </div>
            </div>
        </div>
        <div class="installation-method">
            ...
            <div class="method-content" id="manual-content">
                ...
                <div class="code-container">
                    ...
                    <pre id="manual-install">npx mcp start --api-key ... --api-secret ... --oauth2 ... --cloud-name ...</pre>
                </div>
                ...
                <div class="code-container">
                    ...
                    <pre id="manual-help">npx mcp --help</pre>
                </div>
            </div>
        </div>
        </div>
